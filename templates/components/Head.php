    ...
    class Head extends Component {
        public function render ()
        {
            ?>
                ...
                <link rel="icon" href="<?php $this->public("/assets/favicon.svg") ?>" type="image/svg+xml">
                <link rel="icon" href="<?php $this->public("/assets/favicon.png") ?>" type="image/png">
                <link rel="shortcut icon" href="<?php $this->public("/assets/favicon.svg") ?>" type="image/svg+xml">

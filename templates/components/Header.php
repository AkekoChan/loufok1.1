                    ...
                    <div class="accessibility-popup" id="accessibilty">
                        <ul>
                            ...
                            <li class="accessibility-dyslexic">
                                Mode dyslexie
                                <span tabindex="0" class="toggle-switch switch-dyslexic" role="switch" aria-label="Mode dyslexie" aria-checked="false">
                                    <span class="toggle-knob"></span>
                                </span>
                            </li>
                            <li class="accessibility-disabledGSAPAnimation">
                                Désactiver les animations
                                <span tabindex="0" class="toggle-switch switch-animation" role="switch" aria-label="Désactiver les animations" aria-checked="false">
                                    <span class="toggle-knob"></span>
                                </span>
                            </li>

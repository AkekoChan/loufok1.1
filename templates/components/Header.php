                    ...
                    <div class="accessibility-popup">
                        <ul>
                            <li class="accessibility-font">
                                <button class="increaseFontButton">A+</button>
                                <button class="resetFontButton">A</button>
                                <button class="decreaseFontButton">A-</button>
                            </li>
                            ...
                            <li class="accessibility-daltonism">
                                <button data-value="normal" class="theme-button">Normal</button>
                                <button data-value="protanopia" class="theme-button">Daltonisme rouge</button>
                                <button data-value="tritanopia" class="theme-button">Daltonisme bleu</button>
                                <button data-value="deuteranopia" class="theme-button">Daltonisme vert</button>

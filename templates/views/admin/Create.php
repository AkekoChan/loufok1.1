    ...
    <main>
        <section class="new-cadaver">
            ...
            ?>
                    ...
                    <input type="text" id="cadaver-title" class="new-cadaver__input form__input bottom-fade"
                        name="cadaver-title" tabindex="-1" placeholder="Titre du Cadavre Exquis" required />

                    <input type="number" min="1" id="contributions-count"
                        class="new-cadaver__input form__input bottom-fade" name="contributions-count" tabindex="-1"
                        placeholder="Nombre de contributions maxiumum" required />
                    ...
                    <div class="js-calendar calendar">
                        ...
                        <div class="calendar__head">
                            <div class="calendar__head--container">
                                <i tabindex="0" role="button" class="calendar__head--switch switch__left"
                                    data-switch="1"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
                                            d="M18.6 11.2l-12-9A1 1 0 005 3v18a1 1 0 00.55.89 1 1 0 001-.09l12-9a1 1 0 000-1.6z" />
                                    </svg></i>
                                <span class="calendar__head--date">Janvier 1970</span>
                                <i tabindex="0" role="button" class="calendar__head--switch switch__right"
                                    data-switch="-1"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
                                            d="M18.6 11.2l-12-9A1 1 0 005 3v18a1 1 0 00.55.89 1 1 0 001-.09l12-9a1 1 0 000-1.6z" />
                                    </svg></i>
